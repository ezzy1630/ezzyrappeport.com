...
const ENCOUNTER_BEATS: Readonly<Record<string, readonly EncounterBeat[]>> = {
  ...
  flowe: [
    ...
    { label: "Dump", shortLabel: "Dump", detail: "text or voice → 3 drafts", start: 0.2, end: 0.32, accent: "#44b8d0" },
    { label: "Parse", shortLabel: "Parse", detail: "2 tasks · 1 study session", start: 0.3, end: 0.43, accent: "#5ac5d4" },
    { label: "Context", shortLabel: "Class", detail: "Canvas deadlines + PSYC-2", start: 0.41, end: 0.55, accent: "#73c8de" },
