  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ display: "flex", fontSize: 22, color: deep ? "#cfe6ff" : "#0a3a5c", letterSpacing: 5, marginBottom: 18 }}>
          {project.index} · {project.year}
        </div>
        <div style={{ display: "flex", fontSize: 88, fontWeight: 700, color: deep ? "#f4f9ff" : "#071824", lineHeight: 0.95, letterSpacing: -2 }}>
          {project.title}
        </div>
        <div style={{ display: "flex", marginTop: 22, fontSize: 28, color: deep ? "#9fd0ff" : "#1a4a6a", maxWidth: 820, lineHeight: 1.25 }}>
          {project.tagline}
        </div>
      </div>
    ),
