...
const FLOWE_BEATS = [
  { name: "00a-logo-first-light", progress: 0.15 },
  { name: "00b-logo-outer-curve", progress: 0.172 },
  { name: "00c-logo-inner-loop", progress: 0.198 },
  { name: "00d-logo-bridge", progress: 0.225 },
  { name: "00e-logo-tail", progress: 0.26 },
  { name: "00f-logo-resolved", progress: 0.295 },
  { name: "00g-logo-handoff", progress: 0.322 },
  { name: "01a-brain-dump-arrives", progress: 0.338 },
  { name: "01b-calendar-check", progress: 0.372 },
  { name: "02a-drafts-split", progress: 0.4 },
  { name: "02b-review-ready", progress: 0.452 },
  { name: "03a-context-links", progress: 0.49 },
  { name: "03b-course-context", progress: 0.545 },
  { name: "04a-plan-guides", progress: 0.582 },
  { name: "04b-plan-populates", progress: 0.625 },
  { name: "04c-plan-ready", progress: 0.675 },
